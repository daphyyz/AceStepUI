...
/**
 * Build the 55 positional arguments for the Gradio /generation_wrapper endpoint.
 */
async function buildGradioArgs(params: GenerationParams): Promise<unknown[]> {
  ...
  return [
    ...
    params.coverNoiseStrength ?? 1.0,                             // 19: Cover Noise Strength
    ...
    params.normalizationDb ?? -1.0,                               // 47: Normalization dB
    params.latentShift ?? 0,                                      // 48: Latent Shift
    params.latentRescale ?? 1.0,                                  // 49: Latent Rescale
    params.autogen ?? false,                                      // 50: AutoGen
    0,                                                            // 51: Current Batch Index
    1,                                                            // 52: Total Batches
    [],                                                           // 53: Batch Queue
